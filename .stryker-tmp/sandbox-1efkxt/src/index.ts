...
export { expandEnvRefs, parseFleetConfig, resolveCredentials, type EndpointAuth, type FleetConfig, type FleetParseResult, type TargetConfig } from "./cli/config.js";
export { DEFAULT_APPROVALS_PORT, loadFleet, mergeCandidates, parseBundle, renderBundle, requireApproved, runAuthzApprove, runAuthzList, runAuthzNew, runEnroll, runPing, runReceive, runSend, selectTarget, worktreeNameFromBranch, type AuthzNewDeps, type AuthzNewInput, type AuthzNewReport, type Bundle, type EnrollDeps, type EnrollOutcome, type PingCandidate, type PingDeps, type PingResult, type ReceiveCliReport, type ReceiveCommandDeps, type SendCommandDeps, type SendOutcome, type TargetSelection } from "./cli/handlers.js";
export { APPROVE_PATH, approveRecord, boundUrl, claimUrl, commit, consumeRecord, createQrRenderer, fileAuthzStore, isExpired, memoryAuthzStore, newRequest, nodeAuthzCrypto, parseClaimUrl, purgeFinished, startApprovalServer, type ApprovalServerDeps, type ApproveOutcome, type AuthzAction, type AuthzCrypto, type AuthzRequest, type AuthzStatus, type AuthzStore, type ClaimParts, type ConsumeOutcome, type CreatedRequest, type NewRequestInput, type QrRenderer, type QrRunner, type StartOptions } from "./authz/index.js";

// Discovery slot (reference implementation: Tailscale)
export { candidateBaseUrls, parseTailscaleStatus, stripTrailingDot, type DiscoveredPeer, type StatusRunner } from "./discovery/tailscale.js";
export { probe, type FetchAbortable, type ProbeResult } from "./discovery/probe.js";
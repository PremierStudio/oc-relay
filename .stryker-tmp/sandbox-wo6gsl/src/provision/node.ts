      ...
      run: async (command: string): Promise<HookResult> => {
        if (stryMutAct_9fa48("793")) {
                ...
                exec(command, stryMutAct_9fa48("796") ? {} : (stryCov_9fa48("796"), {
                  ...
                  if (stryMutAct_9fa48("797")) {
                    ...
                    resolve(stryMutAct_9fa48("800") ? {} : (stryCov_9fa48("800"), {
                      code: error ? stryMutAct_9fa48("801") ? raw && 1 : (stryCov_9fa48("801"), raw ?? 1) : 0,
                      stdout,
                      stderr
                    }));
                  }
          ...
          return stryMutAct_9fa48("802") ? {} : (stryCov_9fa48("802"), {
            command,
            code: result.code,
            durationMs: stryMutAct_9fa48("803") ? Date.now() + started : (stryCov_9fa48("803"), Date.now() - started),
  ...
  if (stryMutAct_9fa48("804")) {
    ...
    try {
      ...
      if (stryMutAct_9fa48("806")) {
        ...
        stryCov_9fa48("806");
        return stryMutAct_9fa48("807") ? ["Stryker was here"] : (stryCov_9fa48("807"), []);
      }
    }
  }
}
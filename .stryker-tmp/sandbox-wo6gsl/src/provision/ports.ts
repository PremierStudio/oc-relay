...
export class ManifestInvalidError extends Error {
  ...
  constructor(diagnostics: Diagnostic[]) {
    if (stryMutAct_9fa48("808")) {
      ...
      stryCov_9fa48("808");
      super(stryMutAct_9fa48("809") ? `` : (stryCov_9fa48("809"), `invalid env manifest: ${diagnostics.length} error(s)`));
      this.name = stryMutAct_9fa48("810") ? "" : (stryCov_9fa48("810"), "ManifestInvalidError");
